...
if("${show_ref_output}" MATCHES "refs/remotes/5f8249691ec8c25775789498951f8e9eb62c201d")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "5f8249691ec8c25775789498951f8e9eb62c201d")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "5f8249691ec8c25775789498951f8e9eb62c201d")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/KhronosGroup/OpenCL-ICD-Loader.git'")
  endif()
