...
execute_process(
  COMMAND "/root/miniconda/bin/git" show-ref "23710f1b99186065c1768fc3098ba681adc0f253"
  WORKING_DIRECTORY "/home/mlx/repos/llvm-mlu/build/_deps/ocl-headers-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/23710f1b99186065c1768fc3098ba681adc0f253")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "23710f1b99186065c1768fc3098ba681adc0f253")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "23710f1b99186065c1768fc3098ba681adc0f253")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/KhronosGroup/OpenCL-Headers.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/mlx/repos/llvm-mlu/build/_deps/ocl-headers-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/mlx/repos/llvm-mlu/build/_deps/ocl-headers-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
