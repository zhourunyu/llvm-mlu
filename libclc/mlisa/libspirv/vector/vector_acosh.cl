...
_CLC_INLINE void __cn_vector_acosh_f32(int n, float *y, const float *x) {
...
_CLC_INLINE void __cn_vector_acosh_f16(int n, half *y, const half *x) {
...
#define __CLC_FUNCTION __spirv_ocl_vector_acosh
#define __CLC_BUILTIN __cn_vector_acosh
