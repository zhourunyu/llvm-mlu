...
half __cn_scalar_abs_f16(half x);
half __cn_scalar_acos_f16(half x);
half __cn_scalar_asin_f16(half x);
half __cn_scalar_atan_f16(half x);
half __cn_scalar_ceil_f16(half x);
half __cn_scalar_cos_f16(half x);
half __cn_scalar_cosh_f16(half x);
half __cn_scalar_erf_f16(half x);
half __cn_scalar_exp10_f16(half x);
half __cn_scalar_exp2_f16(half x);
half __cn_scalar_exp_f16(half x);
half __cn_scalar_expm1_f16(half x);
half __cn_scalar_floor_f16(half x);
half __cn_scalar_log10_f16(half x);
half __cn_scalar_log1p_f16(half x);
half __cn_scalar_log2_f16(half x);
half __cn_scalar_log_f16(half x);
half __cn_scalar_round_f16(half x);
half __cn_scalar_rsqrt_f16(half x);
half __cn_scalar_sign_f16(half x);
half __cn_scalar_sin_f16(half x);
half __cn_scalar_sinh_f16(half x);
half __cn_scalar_sqrt_f16(half x);
half __cn_scalar_tan_f16(half x);
half __cn_scalar_tanh_f16(half x);
half __cn_scalar_trunc_f16(half x);

short __cn_scalar_isinf_f16(half x);
short __cn_scalar_isnan_f16(half x);

half __cn_scalar_add_f16_rn(half x, half y);
half __cn_scalar_atan2_f16(half y, half x);
half __cn_scalar_div_f16_rn(half x, half y);
half __cn_scalar_hypot_f16(half x, half y);
half __cn_scalar_max_f16(half x, half y);
half __cn_scalar_min_f16(half x, half y);
half __cn_scalar_mod_f16(half x, half y);
half __cn_scalar_mul_f16_rn(half x, half y);
half __cn_scalar_pow_f16(half x, half y);
half __cn_scalar_sub_f16_rn(half x, half y);

half __cn_scalar_fma_f16(half x, half y, half z);

void __cn_vector_abs_f16(int n, half *y, const half *x);
void __cn_vector_acos_f16(int n, half *y, const half *x);
void __cn_vector_asin_f16(int n, half *y, const half *x);
void __cn_vector_atan_f16(int n, half *y, const half *x);
void __cn_vector_ceil_f16(int n, half *y, const half *x);
void __cn_vector_cos_f16(int n, half *y, const half *x);
void __cn_vector_cosh_f16(int n, half *y, const half *x);
void __cn_vector_erf_f16(int n, half *y, const half *x);
void __cn_vector_exp10_f16(int n, half *y, const half *x);
void __cn_vector_exp2_f16(int n, half *y, const half *x);
void __cn_vector_exp_f16(int n, half *y, const half *x);
void __cn_vector_expm1_f16(int n, half *y, const half *x);
void __cn_vector_floor_f16(int n, half *y, const half *x);
void __cn_vector_log10_f16(int n, half *y, const half *x);
void __cn_vector_log1p_f16(int n, half *y, const half *x);
void __cn_vector_log2_f16(int n, half *y, const half *x);
void __cn_vector_log_f16(int n, half *y, const half *x);
void __cn_vector_negate_f16(int n, half *y, const half *x);
void __cn_vector_round_f16(int n, half *y, const half *x);
void __cn_vector_rsqrt_f16(int n, half *y, const half *x);
void __cn_vector_sign_f16(int n, half *y, const half *x);
void __cn_vector_sin_f16(int n, half *y, const half *x);
void __cn_vector_sinh_f16(int n, half *y, const half *x);
void __cn_vector_sqrt_f16(int n, half *y, const half *x);
void __cn_vector_tan_f16(int n, half *y, const half *x);
void __cn_vector_tanh_f16(int n, half *y, const half *x);
void __cn_vector_trunc_f16(int n, half *y, const half *x);

void __cn_vector_add_f16_rn(int n, half *z, const half *x, const half *y);
void __cn_vector_add_scalar_f16_rn(int n, half *z, const half *x, const half y);
void __cn_vector_atan2_f16(int n, half *z, const half *y, const half *x);
void __cn_scalar_div_vector_f16_rn(int n, half *z, const half x, const half *y);
void __cn_vector_div_f16_rn(int n, half *z, const half *x, const half *y);
void __cn_vector_div_scalar_f16_rn(int n, half *z, const half *x, const half y);
void __cn_vector_max_f16(int n, half *z, const half *x, const half *y);
void __cn_vector_max_scalar_f16(int n, half *z, const half *x, const half y);
void __cn_vector_min_f16(int n, half *z, const half *x, const half *y);
void __cn_vector_min_scalar_f16(int n, half *z, const half *x, const half y);
void __cn_vector_mod_f16(int n, half *z, const half *x, const half *y);
void __cn_vector_mul_f16_rn(int n, half *z, const half *x, const half *y);
void __cn_vector_mul_scalar_f16_rn(int n, half *z, const half *x, const half y);
void __cn_vector_pow_f16(int n, half *z, const half *x, const half *y);
void __cn_scalar_sub_vector_f16_rn(int n, half *z, const half x, const half *y);
void __cn_vector_sub_f16_rn(int n, half *z, const half *x, const half *y);
void __cn_vector_sub_scalar_f16_rn(int n, half *z, const half *x, const half y);

void __cn_vector_eq_f16(int n, bool *z, const half *x, const half *y);
void __cn_vector_eq_scalar_f16(int n, bool *z, const half *x, const half y);
void __cn_vector_ge_f16(int n, bool *z, const half *x, const half *y);
void __cn_vector_ge_scalar_f16(int n, bool *z, const half *x, const half y);
void __cn_vector_gt_f16(int n, bool *z, const half *x, const half *y);
void __cn_vector_gt_scalar_f16(int n, bool *z, const half *x, const half y);
void __cn_vector_le_f16(int n, bool *z, const half *x, const half *y);
void __cn_vector_le_scalar_f16(int n, bool *z, const half *x, const half y);
void __cn_vector_lt_f16(int n, bool *z, const half *x, const half *y);
void __cn_vector_lt_scalar_f16(int n, bool *z, const half *x, const half y);
void __cn_vector_ne_f16(int n, bool *z, const half *x, const half *y);
void __cn_vector_ne_scalar_f16(int n, bool *z, const half *x, const half y);

void __cn_vector_cast_f16_to_f32(int n, float *y, const half *x);
void __cn_vector_cast_f16_to_s8_tz(int n, signed char *y, const half *x);
void __cn_vector_cast_f16_to_u8_tz(int n, unsigned char *y, const half *x);
void __cn_vector_cast_f16_to_s16_tz(int n, short *y, const half *x);
void __cn_vector_cast_f16_to_u16_tz(int n, unsigned short *y, const half *x);
void __cn_vector_cast_f16_to_s32_tz(int n, int *y, const half *x);
void __cn_vector_cast_f16_to_u32_tz(int n, unsigned int *y, const half *x);
void __cn_vector_cast_f16_to_s64_tz(int n, long *y, const half *x);
void __cn_vector_cast_f16_to_u64_tz(int n, unsigned long *y, const half *x);
void __cn_vector_cast_f32_to_f16_rn(int n, half *y, const float *x);
void __cn_vector_cast_s8_to_f16(int n, half *y, const signed char *x);
void __cn_vector_cast_u8_to_f16(int n, half *y, const unsigned char *x);
void __cn_vector_cast_s16_to_f16_rn(int n, half *y, const short *x);
void __cn_vector_cast_u16_to_f16_rn(int n, half *y, const unsigned short *x);
void __cn_vector_cast_s32_to_f16_rn(int n, half *y, const int *x);
void __cn_vector_cast_u32_to_f16_rn(int n, half *y, const unsigned int *x);
void __cn_vector_cast_s64_to_f16_rn(int n, half *y, const long *x);
void __cn_vector_cast_u64_to_f16_rn(int n, half *y, const unsigned long *x);
#endif

float __cn_scalar_abs_f32(float x);
float __cn_scalar_acos_f32(float x);
float __cn_scalar_asin_f32(float x);
float __cn_scalar_atan_f32(float x);
float __cn_scalar_ceil_f32(float x);
float __cn_scalar_cos_f32(float x);
float __cn_scalar_cosh_f32(float x);
float __cn_scalar_erf_f32(float x);
float __cn_scalar_exp10_f32(float x);
float __cn_scalar_exp2_f32(float x);
float __cn_scalar_exp_f32(float x);
float __cn_scalar_expm1_f32(float x);
float __cn_scalar_floor_f32(float x);
float __cn_scalar_lgamma_f32(float x);
float __cn_scalar_log10_f32(float x);
float __cn_scalar_log1p_f32(float x);
float __cn_scalar_log2_f32(float x);
float __cn_scalar_log_f32(float x);
float __cn_scalar_round_f32(float x);
float __cn_scalar_rsqrt_f32(float x);
float __cn_scalar_sign_f32(float x);
float __cn_scalar_sin_f32(float x);
float __cn_scalar_sinh_f32(float x);
float __cn_scalar_sqrt_f32(float x);
float __cn_scalar_tan_f32(float x);
float __cn_scalar_tanh_f32(float x);
float __cn_scalar_trigamma_f32(float x);
float __cn_scalar_trunc_f32(float x);

int __cn_scalar_isinf_f32(float x);
int __cn_scalar_isnan_f32(float x);

float __cn_scalar_add_f32_rn(float x, float y);
float __cn_scalar_atan2_f32(float y, float x);
float __cn_scalar_div_f32_rn(float x, float y);
float __cn_scalar_hypot_f32(float x, float y);
float __cn_scalar_max_f32(float x, float y);
float __cn_scalar_min_f32(float x, float y);
float __cn_scalar_mod_f32(float x, float y);
float __cn_scalar_mul_f32_rn(float x, float y);
float __cn_scalar_pow_f32(float x, float y);
float __cn_scalar_sub_f32_rn(float x, float y);
...
void __cn_vector_exp10_f32(int n, float *y, const float *x);
void __cn_vector_exp2_f32(int n, float *y, const float *x);
void __cn_vector_exp_f32(int n, float *y, const float *x);
void __cn_vector_expm1_f32(int n, float *y, const float *x);
void __cn_vector_floor_f32(int n, float *y, const float *x);
void __cn_vector_lgamma_f32(int n, float *y, const float *x);
void __cn_vector_log10_f32(int n, float *y, const float *x);
void __cn_vector_log1p_f32(int n, float *y, const float *x);
...
void __cn_vector_negate_s16(int n, short *y, const short *x);
...
void __cn_vector_sign_s32(int n, int *y, const int *x);
void __cn_vector_sign_s64(int n, long *y, const long *x);
...
void __cn_vector_trigamma_f32(int n, float *y, const float *x);
...
void __cn_vector_add_s16(int n, short *z, const short *x, const short *y);
...
void __cn_vector_add_scalar_s16(int n, short *z, const short *x, const short y);
...
void __cn_vector_atan2_f32(int __n, float *z, const float *y, const float *x);
...
void __cn_scalar_sub_vector_s16(int n, short *z, const short x, const short *y);
...
void __cn_vector_sub_s16(int n, short *z, const short *x, const short *y);
...
void __cn_vector_sub_scalar_s16(int n, short *z, const short *x, const short y);
...
void __cn_vector_cast_f32_to_s8_tz(int n, signed char *y, const float *x);
...
void __cn_vector_cast_s8_to_f32(int n, float *y, const signed char *x);
void __cn_vector_cast_s8_to_u8(int n, unsigned char *y, const signed char *x);
void __cn_vector_cast_s8_to_s16(int n, short *y, const signed char *x);
void __cn_vector_cast_s8_to_u16(int n, unsigned short *y, const signed char *x);
void __cn_vector_cast_s8_to_s32(int n, int *y, const signed char *x);
void __cn_vector_cast_s8_to_u32(int n, unsigned int *y, const signed char *x);
void __cn_vector_cast_s8_to_s64(int n, long *y, const signed char *x);
void __cn_vector_cast_s8_to_u64(int n, unsigned long *y, const signed char *x);
void __cn_vector_cast_u8_to_f32(int n, float *y, const unsigned char *x);
void __cn_vector_cast_u8_to_s8(int n, signed char *y, const unsigned char *x);
...
void __cn_vector_cast_s16_to_s8(int n, signed char *y, const short *x);
...
void __cn_vector_cast_u16_to_s8(int n, signed char *y, const unsigned short *x);
...
void __cn_vector_cast_s32_to_s8(int n, signed char *y, const int *x);
...
void __cn_vector_cast_u32_to_s8(int n, signed char *y, const unsigned int *x);
...
void __cn_vector_cast_s64_to_s8(int n, signed char *y, const long *x);
...
void __cn_vector_cast_u64_to_s8(int n, signed char *y, const unsigned long *x);
