...
#else // __SYCL_NVPTX__ || defined(__SYCL_AMDGCN__) || defined(__SYCL_MLISA__)
...
#endif // __SYCL_NVPTX__ || defined(__SYCL_AMDGCN__) || defined(__SYCL_MLISA__)
