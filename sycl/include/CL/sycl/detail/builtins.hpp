...
__SYCL_MAKE_CALL_VEC_ARG1(vector_cast, __FUNC_PREFIX_OCL)
...
__SYCL_MAKE_CALL_VEC_ARG1(vector_log2, __FUNC_PREFIX_OCL)
__SYCL_MAKE_CALL_VEC_ARG1(vector_log10, __FUNC_PREFIX_OCL)
