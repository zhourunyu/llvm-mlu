...
Value *CodeGenFunction::EmitMLISABuiltinExpr(unsigned BuiltinID,
  ...
  case MLISA::BI__mlvm_stream_add_f32: {
   ...
   case MLISA::BI__mlvm_stream_sub_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_sub_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_mul_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_mul_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_div_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_div_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_square_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_square_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_sqrt_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_sqrt_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_sin_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_sin_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_cos_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_cos_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_relu_f16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_relu_f16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_relu_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_relu_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_relu_s8: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_relu_s8);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_relu_s16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_relu_s16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_relu_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_relu_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_active_abs_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_active_abs_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_active_relu_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_active_relu_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_maxeq_scalar_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_maxeq_scalar_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_mineq_scalar_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_mineq_scalar_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_eq_scalar_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_eq_scalar_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_ne_scalar_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_ne_scalar_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_lt_scalar_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_lt_scalar_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_le_scalar_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_le_scalar_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_gt_scalar_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_gt_scalar_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_ge_scalar_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_ge_scalar_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_maxeq_scalar_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_maxeq_scalar_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_mineq_scalar_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_mineq_scalar_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_eq_scalar_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_eq_scalar_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_ne_scalar_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_ne_scalar_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_lt_scalar_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_lt_scalar_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_le_scalar_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_le_scalar_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_gt_scalar_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_gt_scalar_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_stream_ge_scalar_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_stream_ge_scalar_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_nram_to_nram: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_nram_to_nram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_nram_to_wram: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_nram_to_wram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_nram_to_sram: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_nram_to_sram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_nram_to_ldram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_nram_to_ldram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_nram_to_gdram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_nram_to_gdram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_wram_to_nram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_wram_to_nram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_wram_to_sram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_wram_to_sram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_wram_to_ldram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_wram_to_ldram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_wram_to_gdram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_wram_to_gdram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_sram_to_nram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_sram_to_nram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_sram_to_wram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_sram_to_wram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_sram_to_sram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_sram_to_sram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_sram_to_ldram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_sram_to_ldram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_sram_to_gdram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_sram_to_gdram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_ldram_to_nram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_ldram_to_nram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_ldram_to_wram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_ldram_to_wram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_ldram_to_sram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_ldram_to_sram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_gdram_to_nram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_gdram_to_nram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_gdram_to_wram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_gdram_to_wram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memcpy_gdram_to_sram:  {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memcpy_1D_gdram_to_sram);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src1 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src1x, Int8PtrTy);
  ...
  case MLISA::BI__mlvm_memset_nram_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_nram_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
    return Builder.CreateCall(F, {Src0, Src1x, Src2x});
  }
  case MLISA::BI__mlvm_memset_nram_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_nram_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset_nram_f16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_nram_f16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset_nram_s16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_nram_s16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset_nram_s8: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_nram_s8);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset_gdram_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_gdram_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset_gdram_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_gdram_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset_gdram_f16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_gdram_f16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset_gdram_s16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_gdram_s16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset_gdram_s8: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset_gdram_s8);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_nram_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_nram_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
    Value *Src3x = EmitScalarExpr(E->getArg(3));
    Value *Src4x = EmitScalarExpr(E->getArg(4));
    Value *Src5x = EmitScalarExpr(E->getArg(5));
    Value *Src6x = EmitScalarExpr(E->getArg(6));
    return Builder.CreateCall(F, {Src0, Src1x, Src2x, Src3x, Src4x, Src5x, Src6x});
  }
  case MLISA::BI__mlvm_memset3d_nram_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_nram_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_nram_f16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_nram_f16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_nram_s16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_nram_s16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_nram_s8: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_nram_s8);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_gdram_f32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_gdram_f32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_gdram_s32: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_gdram_s32);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_gdram_f16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_gdram_f16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_gdram_s16: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_gdram_s16);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
  ...
  case MLISA::BI__mlvm_memset3d_gdram_s8: {
    llvm::Function *F = CGM.getIntrinsic(Intrinsic::mlvm_memset3d_gdram_s8);
    Value *Src0x = EmitScalarExpr(E->getArg(0));
    Value *Src0 = Builder.CreatePointerBitCastOrAddrSpaceCast(Src0x, Int8PtrTy);
    Value *Src1x = EmitScalarExpr(E->getArg(1));
    Value *Src2x = EmitScalarExpr(E->getArg(2));
